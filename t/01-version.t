...
if AUTHOR {
  is archive_version_number, 3002002, 'version number';
  is archive_version_string, 'libarchive 3.2.2', 'version string';
  is archive_version_details, 'libarchive 3.2.2 zlib/1.2.11 liblzma/5.2.2 bz2lib/1.0.6 liblz4/1.8.2', 'version details';
